use rhwp::collaboration::{
    apply_collaboration_patch, build_collaboration_manifest, CollaborationError, CollaborationPatch,
    ImageMediaType, InsertedImagePatch, NodeKind, StableId, TextReplacement,
};
